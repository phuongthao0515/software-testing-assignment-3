...
class TestUsecase_Cancel(unittest.TestCase):
    ...
    def verify_result(self, page: NewForumPage, row: dict):
        ...
        course_name = self.wait.until(EC.presence_of_element_located((By.XPATH, "//header[@id='page-header']/div/div[2]/div/div/div/div/h1"))).text
